...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/signUpSeeker.css?v=1.5') }}">
    <div class="signup-container">
        ...
        <div class="text-center">
            <a href="{{ route('blogs.index') }}" class="back-to-blogs-btn">Back to Blogs</a>
        </div>

        <script src="{{ asset('js/signupSeeker.js?v=1.5') }}"></script>
    </div>
@endsection
