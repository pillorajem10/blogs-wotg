...
@section('content')
    <div>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="signup-form">
                <div>
                    ...
                    <div class="form-group">
                        <label for="user_already_a_dgroup_leader">Are you already a D-Group Leader?</label>
                    ...
                    <div id="dgroup-leader-note">
                        <p>
                            <strong>Note:</strong>
                            To verify your account, give your email address to your dgroup members 
                            and ask them to register on our WOTG app. 
                            They should enter your email in the dgroup leader’s email field. 
                            Once they register, check your email for their request and approve 
                            it to complete the verification process.
                        </p>
                    </div>                    
                </div>
                ...
                <div>
                    <div class="form-group">
                        <label for="user_already_a_dgroup_member">Are you already a D-Group Member?</label>
                    ...
                    <!-- Placeholder for the D-Group Member Note -->
                    <div id="dgroup-member-note">
                        <p><strong>Note:</strong> If you are a D-Group member, please provide your D-Group leader’s email to complete your registration.</p>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="user_dgroup_leader">Dgroup Leader</label>
        ...
        <script src="{{ asset('js/auth.js?v=1.7') }}"></script>
    </div>
@endsection
